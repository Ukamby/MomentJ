...
/**
 * zh-tw language constants for MomentJ.
 *
 * User: luke
 * Date: 4/6/2013
 */
public abstract class MomentLanguageZH_TW extends MomentLanguage {
	...
	private static final String[] weekdaysShort = new String[]{"週日","週一","週二","週三","週四","週五","週六"};
